...
class Factory {
    static boardFactory() {
        return {
            0: { "color": Color.WHITE, "is_roll_again": true, "neighbors": {[Direction.DOWN]: 10, [Direction.RIGHT]: 1} },
            ...
            4: { "color": Color.RED, "is_HQ": true, "neighbors": {[Direction.LEFT]: 3, [Direction.RIGHT]: 5, [Direction.DOWN]: 14} },
            ...
            8: { "color": Color.WHITE, "is_roll_again": true, "neighbors": {[Direction.LEFT]: 7, [Direction.DOWN]: 18} },
            ...
            40: { "color": Color.YELLOW, "is_HQ": true, "neighbors": {[Direction.UP]: 30, [Direction.DOWN]: 50, [Direction.RIGHT]: 41} },
            ...
            44: { "color": Color.WHITE, "is_center": true, "neighbors": {[Direction.LEFT]: 43, [Direction.RIGHT]: 45, [Direction.UP]: 34, [Direction.DOWN]: 54} },
            ...
            48: { "color": Color.GREEN, "is_HQ": true, "neighbors": {[Direction.LEFT]: 47, [Direction.UP]: 38, [Direction.DOWN]: 58} },
            ...
            80: { "color": Color.WHITE, "is_roll_again": true, "neighbors": {[Direction.UP]: 70, [Direction.RIGHT]: 81} },
            ...
            84: { "color": Color.BLUE, "is_HQ": true, "neighbors": {[Direction.LEFT]: 83, [Direction.RIGHT]: 85} },
            ...
            88: { "color": Color.WHITE, "is_roll_again": true, "neighbors": {[Direction.LEFT]: 87, [Direction.UP]: 78} },
        };
    }
}
